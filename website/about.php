...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>About</span> #SpamS</h2>
          <div class="clr"></div>
          <p><strong>Buy and sell new products very easily.</strong></p>
        </div>
        <div class="article">
          <h2><span>Our Mission</span></h2>
          <div class="clr"></div>
          <p><strong>To make the transaction easier and faster.</strong></p>
        </div>
      </div>
      <div class="sidebar">
