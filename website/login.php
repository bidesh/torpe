  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <form name="login" action="handlelogin.php" method="POST">
          Username:<input id="username" type="text" name="username" placeholder="Campusnet ID"> </input></br>
          Password: <input id="password" type="password" name="password" placeholder = "Password"> </input></br>
